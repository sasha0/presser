...
parser.add_option('-s', '--scenario', dest='scenario', action='store', type='string', help='Path to file with benchmarking scenario.')
...
parser.add_option('-p', '--auth_password', dest='auth_password', action='store', help='Password for HTTP authorization.')
